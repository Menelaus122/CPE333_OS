...
└── PS07/                  # Problem Session 7: Concurrency and Thread (race condition บนบัญชีเงินฝากร่วม)
    ...
    │   ├── PS07.pdf       # รายงานฉบับสมบูรณ์ (PDF) 7 หน้า รวมปกและสารบัญ
...
- **รายงานเขียนแบบสั้นตามที่ใบงานขอ** (*a short report*) มีเฉพาะคำอธิบายโค้ดส่วนสำคัญ ผลการรัน Task 1–3 และการอภิปรายสาเหตุ ซอร์สโค้ดฉบับเต็มส่งแยกเป็นไฟล์ `ps7.c`
