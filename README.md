...
└── PS07/                  # Problem Session 7: Concurrency and Thread (race condition บนบัญชีเงินฝากร่วม)
    ...
    │   ├── PS07.pdf       # รายงานฉบับสมบูรณ์ (PDF) 16 หน้า
...
- **รายงานมีสองฉบับจากต้นฉบับเดียว** เหมือน PS06 `PS07/tools/build_report.js` ต่อยอดจากของ PS06 ให้รองรับ `\lstinputlisting` (ภาคผนวกซอร์สโค้ด) และ `\mbox{}` และให้รายการลำดับเลขแต่ละชุดเริ่มนับใหม่
